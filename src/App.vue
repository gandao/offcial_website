          ...
          <ul class="nav_wrapper">
            <li @click.stop.prevent="fun_menu(index)" class="first_menu" v-for="(item,index) in menu_data" :key =index>
              ...
              <ul ref="second_menu" class="second_menu">
                <li @mouseout="fun_menu_two_out(index,index1)" @mouseover="fun_menu_two(index,index1)" class="second_menu_li" v-for="(item1,index1) in item.second_menu" :key=index1>
